...
@Component({
  selector: 'app-slaider-certific',
  templateUrl: './slaider-certific.component.html',
  styleUrls: ['./slaider-certific.component.css']
})

export class SlaiderCertificComponent implements OnInit {

@Input() imagenes: caruselImagen[] = []
@Input() indicators =true;
@Input() controls =true;
@Input() auntoSlide =false;
@Input() sliderIntervalos=6000;
